...
* mean that the function has to draw a filled rectangle.
     * @param lineType Type of the line. See #LineTypes
     */
    public static void rectangle(Mat img, int pt1, int pt2, android.graphics.Point color, Scalar thickness, int lineType) {
...
//
     ...
     * @param lineType automatically generated
     */
    public static void rectangle(Mat img, android.graphics.Point rec, android.graphics.Point color, Scalar thickness, int lineType) {
//        rectangle_5(img.nativeObj, rec.x, rec.y, rec.width, rec.height, color.val[0], color.val[1], color.val[2], color.val[3], thickness, lineType);
        ...
        rectangle(img,rec.x,rec.y,color,thickness,lineType);
    }
