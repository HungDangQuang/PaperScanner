...
public class PolygonView extends FrameLayout {
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        int radius = ImagePreview.dp2px(context, 11);
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            switch (eid) {
                ...
                case MotionEvent.ACTION_DOWN:
                    ImagePreview.allDraggedPointsStack.push(new PolygonPoints(new PointF(pointer1.getX(), pointer1.getY()),
                ...
                case MotionEvent.ACTION_UP:
                    ...
                    if (isValidShape(getPoints()) && isValidPointer1() && isValidPointer2() && isValidPointer3() && isValidPointer4()) {
                        ...
                        ImagePreview.allDraggedPointsStack.pop();
                        color = getResources().getColor(R.color.crop_color);
